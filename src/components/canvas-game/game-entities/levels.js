...
export default { // levels
  ...
  2 : {
    ...
    counterColor : 'white',
    frames : 26,
    background : new Array(26).fill('lava-').map((each,i) => each + (i + 1)), // mattL - lava gif, images 1-26
    bricks : [
  ...
  3 : {
    ...
    spikes : [
      // first row of spikes
      ...new Array(18).fill('').map((each, i) => new game.Spike(320, 50 + (i * 20))),
      // second row of spikes
      ...new Array(12).fill('').map((each, i) => new game.Spike(370, 10 + (i * 20))),
      // first row of spikes at bottom
      ...new Array(4).fill('').map((each, i) => new game.Spike(340 + (i * 20), 390)),
      // third row of spikes
      ...new Array(18).fill('').map((each, i) => new game.Spike(650, 50 + (i * 20))),
      // fourth row of spikes
      ...new Array(12).fill('').map((each, i) => new game.Spike(700, 10 + (i * 20))),
      // second row of spikes at bottom
      ...new Array(4).fill('').map((each, i) => new game.Spike(670 + (i * 20), 390)),
    ],
  },
  ...
  5 : {
    ...
    counterColor : 'white',
    playerPosition : { x : 5, y : 20, width : 30, height : 26 },
    star: {x: 370, y: 110}, 
    bricks : [
    ],
    spikes : [
      ...
      // second spike wall
      new game.Spike(850, 280),
      new game.Spike(850, 260),
      new game.Spike(850, 240),
      new game.Spike(850, 220),
      new game.Spike(850, 200),
      new game.Spike(850, 180),
      new game.Spike(850, 160),
      new game.Spike(850, 140),
      new game.Spike(850, 120),
      new game.Spike(850, 100),
      new game.Spike(850, 80),
      new game.Spike(850, 60),
      new game.Spike(850, 40),
